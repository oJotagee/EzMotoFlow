      ...
      <NumericFormat
        ...
        className={clsx(
           ...
           disabled:opacity-50 disabled:cursor-not-allowed`,
          {
            ...
            "border-destructive text-destructive focus:ring-destructive bg-destructive/5":
              errorMessage,
          },
        )}
        {...input}
  ...
  return (
    <div className="relative w-full flex-1">
      <DatePicker
        ...
        data-test-id={props.testID}
        value={props.value}
        onChange={(selectedDates: DateObject | null) =>
          props.onChange(selectedDates as any)
        }
        editable={false}
...
export function NumberInput(props: NumberInputProps) {
  return (
    <div
      className={`w-full flex flex-col items-start gap-2 ${props.className || ""}`}
    >
  ...
  return (
    ...
    >
      ...
      <InputRoot error={!!props.errorMessage}>
        ...
        />
        <span
          className="flex items-center justify-center cursor-pointer p-2 hover:text-primary transition-colors"

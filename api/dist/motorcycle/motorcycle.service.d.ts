...
import { ResponseAllMotorcycleDto, ResponseMotorcycleDto, PaginatedMotorcyclesResponseDto } from './dto/response.dto';
export declare class MotorcycleService {
    private prismaService;
    private s3Service;
    constructor(prismaService: PrismaService, s3Service: AwsS3Service);
    getAll(filter: FilterDto): Promise<PaginatedMotorcyclesResponseDto>;
